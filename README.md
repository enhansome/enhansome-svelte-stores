...
* [svelte-query](https://github.com/SvelteStack/svelte-query) ⭐ 831 | 🐛 36 | 🌐 TypeScript | 📅 2023-08-25
  * Advanced asynchronous state management including caching, auto-refetching etc. TanStack/query fork?
* [svelte-websocket-store](https://github.com/arlac77/svelte-websocket-store) ⭐ 292 | 🐛 12 | 🌐 JavaScript | 📅 2026-09-26
...
* [svelte-damped-store](https://github.com/aredridel/svelte-damped-store) ⭐ 6 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-18
...
* [stores-x](https://github.com/Anyass3/stores-x) ⭐ 6 | 🐛 0 | 🌐 JavaScript | 📅 2022-05-21
  * State management heaviliy inspired by [VueX](https://github.com/vuejs/vuex) ⭐ 28,309 | 🐛 143 | 🌐 JavaScript | 📅 2024-09-25
